    ...
    function init_epayco_woocommerce()
    {
        ...
        class WC_ePayco extends WC_Payment_Gateway
        {
            ...
            {       
                ...
                if ($isConfirmation){
                    $x_signature = sanitize_text_field($_GET['x_signature']);
                    $x_cod_transaction_state = sanitize_text_field($_GET['x_cod_transaction_state']);
                    $x_ref_payco = sanitize_text_field($_GET['x_ref_payco']);
                    $x_transaction_id = sanitize_text_field($_GET['x_transaction_id']);
                    $x_amount = sanitize_text_field($_GET['x_amount']);
                    $x_currency_code = sanitize_text_field($_GET['x_currency_code']);
                }
                else {
